...
class ProductListView(ListView):
    ...
    def get_queryset(self):
        ...
        queryset.filter(category__slug=category)
        return queryset
...
#     return render(request, 'product/CreateProductHtml.html',
...
#         product_form.save()
#         return redirect(product.get_absolute_url())
#     return render(request, 'product/UpdateProductForm.html',
#                   {'product_form': product_form})

class ProductUpdateView(UpdateView):
    model = Product
    template_name = 'product/UpdateProductForm.html'
